...
public class clsCarrera1kcc {
    ...
    public String addCompetidor1kcc() {
        while (JOptionPane.showConfirmDialog(null,
            ...
            String anio = JOptionPane.showInputDialog("Introducir Año de nacimiento");
            int anior = anio(ValidateID(anio));
    ...
    public String showCompetidor1kcc() {
        ...
        while (!pila1kcc.estaVacia()) {
            ...
            cadena += "Cédula: " + objCompetidor.getCedula()
                    ...
                    + "\n Tiempo: " + objCompetidor.getTiempo()
                    + "\n__________________\n";
    ...
    public String beginR100cc() {
        ...
        while (!pila1kcc.estaVacia()) {
            ...
            auxPila1kcc.apilar(pila1kcc.getElemento());
            pila1kcc.desapilar();
            mayor = objCompetidor.getTiempo();
            if (menor < mayor) {
                menorN = objCompetidor.getNombre();
                menorA = objCompetidor.getApellido();
    ...
    private int anio(String anionacimiento) {
    ...
    public String cant1000() {
        return "Hay "
                + String.valueOf(cantCompetidores1k)
                + " Concursantes en la categoría de 1000cc";
    }
}
